...
void ls_var_list_copy(struct ls_var_list_t *, struct ls_var_list_t *);
void ls_var_list_debug_print(struct ls_var_list_t *);
struct ls_var_t *ls_var_list_add_var(struct ls_var_list_t *, struct ls_var_t *);
struct ls_var_t *ls_var_list_get_var_by_name_and_type(struct ls_var_list_t *, 
  char *, enum ls_var_type_t);
struct ls_var_t *ls_var_list_get_var_by_pos(struct ls_var_list_t *, size_t );
